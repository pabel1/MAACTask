...
import './AboutUs.css';
import aboutDetailsImg from '../../images/sels-group.png';
import usericonImg from '../../images/Ellipse1.png';
...
const AboutUs = () => {
    return (
        <div className='about__us py-20'>
            <div className="top__section flex items-center justify-center">
                <div className='w-2/4'>
