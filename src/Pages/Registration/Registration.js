...
const Registration = () => {
  ...
  return (
    <>
      <Navbar/>
      <div className="registration__banner grid items-center justify-center">
        <form
          className="registration__form items-center justify-center"
        ...
        >
          ...
          <div className="my-5 w-[100%]">
            <input
              className="registration__inputs mt-4"
              type="text"
              name="fullName"
              id=""
            ...
            />
            <select className="registration__inputs" name="role" id="">
